...
const { ensureLoggedIn, ensureAdmin, ensureMatchingUserOrAdmin } = require("../middleware/auth");
...
router.delete("/:username", ensureMatchingUserOrAdmin, async function (req, res, next) {
  try {
